...
Route::get('allotment',"PageController@allotment");
Route::get('uc',"PageController@uc");
Route::get('sanction',"PageController@sanction");
Route::get('sanct_allot',"PageController@sanct_allot");